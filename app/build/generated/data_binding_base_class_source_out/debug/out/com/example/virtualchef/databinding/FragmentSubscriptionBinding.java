...
public final class FragmentSubscriptionBinding implements ViewBinding {
  ...
  private FragmentSubscriptionBinding(@NonNull FrameLayout rootView,
      @NonNull TextView textSubscription) {
  ...
  public static FragmentSubscriptionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.text_subscription;
      TextView textSubscription = ViewBindings.findChildViewById(rootView, id);
      if (textSubscription == null) {
        break missingId;
      }

      return new FragmentSubscriptionBinding((FrameLayout) rootView, textSubscription);
    }
